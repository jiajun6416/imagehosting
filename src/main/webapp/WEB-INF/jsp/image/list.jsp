...
<body>
  <%@include file="../head.jsp" %>
   ...
   <DIV class="container">
     ...
     <DIV class="user">
       <DIV class="user_nav">
         <SPAN class="user_nav_a">
           <a href="album">${sessionScope.session_user_key.username}</a>&gt; ${album.name}</SPAN>
         <span class="user_nav_b" id="create_a" style="margin-top:4px">
           <!-- <input type="button" value="管理相册" onclick="window.location.href='/manage/1357769'" class="cbtn upload_c_a_c_b_a_b"> -->
			<b>每页显示:</b>
			<select class="cbtn upload_c_a_c_b_a_b" style="background-color:#C0C0C0;" >
    ...
    <script>
    	$(function() {
    		$("#number").bind("onkeyup", function() {
    			this.value=this.value.replace(/\D/g,'');
    		});
    		$("#number").bind("onafterpaste", function() {
    			this.value=this.value.replace(/\D/g,'');
    		});
